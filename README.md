...
The current version of Chrome Driver in this repository is **144 - win64**. To ensure compatibility, please check for the latest ChromeDriver version [here](https://googlechromelabs.github.io/chrome-for-testing/).
